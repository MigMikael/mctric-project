                ...
                <div class="col-md-12 col-lg-6">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-6" style="margin-bottom: 1rem;">
                            ...
                            <a href="https://mctric.mangoanywhere.com/production.anywhere/page/authentication/vendor/login"
                        ...
                        <div class="card-body">
                            <form id="talkToCeoForm">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="tel" class="form-control" id="reporter-phone" name="reporter_phone">
                                    <div class="invalid-feedback" id="nameError"></div>
                                </div>
                                <div class="mb-4">
                                    <label class="form-label" style="color: #000;">อีเมลผู้ติดต่อ</label>
                                    <input type="email" class="form-control" id="reporter-email" name="reporter_email">
                                    <div class="invalid-feedback" id="nameError"></div>
                                </div>
                                <div class="mb-4">
